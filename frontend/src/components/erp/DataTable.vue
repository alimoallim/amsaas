      ...
      <table class="min-w-full divide-y divide-slate-200 text-left text-sm">
        <thead class="bg-slate-50/90">
          <tr>
            ...
            <th
              ...
              :key="col.key"
              scope="col"
              class="px-4 py-3 text-xs font-semibold uppercase tracking-wide text-slate-600 sm:px-5"
              :class="[
        ...
        <tbody class="divide-y divide-slate-100 bg-white">
          ...
          <tr
            ...
            :class="{ 'bg-indigo-50/60': isRowSelected(row) }"
          ...
          >
            ...
            <td
              v-for="col in columns"
              :key="col.key"
              class="px-4 py-3.5 text-slate-700 sm:px-5"
...
function cellClasses(col) {
  return [
    ...
    col.emphasis ? 'font-medium text-slate-900' : '',
